...
\begin{frame}[c]{ASR}
	...
	\begin{overprint}
		\onslide<1-2>
			 \movie[width=5cm,height=1cm]{▶️}{audio/common_voice_br_21512915.mp3}
			\begin{description}
		...
		\onslide<3-4>
			\movie[width=5cm,height=1cm]{▶️}{audio/common_voice_br_18187629.mp3}
			\begin{description}
		...
		\onslide<5-7>
			\movie[width=5cm,height=1cm]{▶️}{audio/common_voice_br_33181042.mp3}
			\begin{description}
